...
def create_notification(user, message, notification_type='general', url='#'):
...
def book_appointment(request):
    ...
    try:
        ...
        create_notification(
            user=request.user,
            message=f'Your appointment with {counselor.name} on {appointment_date} at {appointment_time.strftime("%I:%M %p")} has been booked successfully.',
        ...
        if counselor.user:
            create_notification(
                user=counselor.user,
                message=f'New appointment request from {request.user.full_name} on {appointment_date} at {appointment_time.strftime("%I:%M %p")}.',
                notification_type='appointment',
                url=reverse('appointment_detail', args=[appointment.id])
            )
