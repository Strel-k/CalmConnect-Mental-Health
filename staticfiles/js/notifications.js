...
class NotificationManager {
    ...
    renderScheduledFollowupContent(data, metadata) {
        ...
        try {
            ...
            modalContent.innerHTML = `
                <div class="scheduled-followup-details">
                    <div class="session-status" style="
                        ...
                        border-radius: 8px;
                    ">
                        <h4 style="margin: 0 0 10px 0; color: #27ae60; display: flex; align-items: center;">
                            <i class="bx bx-check-circle" style="margin-right: 8px;"></i>
                            Session Scheduled Successfully
                        </h4>
                        <p style="margin: 0; color: #2c3e50; font-size: 14px;">
                            This follow-up session has been scheduled and the student has been notified.
                        </p>
                    </div>
                    ...
                    ">
                        ...
                        <div class="student-details">
                            <h4 style="margin: 0 0 5px 0; color: #2c3e50;">${studentName}</h4>
                            <p style="margin: 0; color: #666; font-size: 14px;">Student ID: ${studentId}</p>
                        </div>
                    </div>

                    <div class="counselor-info" style="
                        display: flex;
                        align-items: center;
                        gap: 15px;
                        margin-bottom: 20px;
                        ...
                        border-radius: 8px;
                    ">
                        <img src="${counselorImage}" alt="${counselorName}" class="counselor-avatar" style="
                            width: 50px;
                            height: 50px;
                            border-radius: 50%;
                            object-fit: cover;
                        ...
                        <div class="counselor-details">
                            <h4 style="margin: 0 0 5px 0; color: #2c3e50;">${counselorName}</h4>
                            <p style="margin: 0; color: #666; font-size: 14px;">${counselorUnit}</p>
                        </div>
                    </div>

                    <div class="appointment-details" style="
                        background: white;
                        border: 1px solid #eee;
                        border-radius: 8px;
                        padding: 20px;
                        margin-bottom: 20px;
                    ">
                        <h4 style="margin: 0 0 15px 0; color: #2c3e50; border-bottom: 2px solid #2ecc71; padding-bottom: 10px;">Appointment Details</h4>
                        ...
                        ">
                            <div class="detail-item">
                                <span class="detail-label" style="font-weight: 600; color: #555; display: block; margin-bottom: 5px;">Date:</span>
                                <span class="detail-value" style="font-weight: 600; color: #2c3e50; font-size: 16px;">${appointmentDate}</span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label" style="font-weight: 600; color: #555; display: block; margin-bottom: 5px;">Time:</span>
                                <span class="detail-value" style="font-weight: 600; color: #2c3e50; font-size: 16px;">${appointmentTime}</span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label" style="font-weight: 600; color: #555; display: block; margin-bottom: 5px;">Session Type:</span>
                                <span class="detail-value" style="font-weight: 600; color: #2c3e50;">${appointmentType}</span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label" style="font-weight: 600; color: #555; display: block; margin-bottom: 5px;">Services:</span>
                                <span class="detail-value" style="font-weight: 600; color: #2c3e50;">${servicesText}</span>
                            </div>
                        </div>
                    </div>

                    <div class="followup-info" style="
                        ...
                        margin-bottom: 20px;
                    ">
                        <h4 style="margin: 0 0 10px 0; color: #2980b9;">Follow-up Reason</h4>
                        <p style="margin: 0; color: #2c3e50; line-height: 1.5;">${followup.reason || 'Follow-up session as requested by counselor.'}</p>
                    </div>
                    ...
                    <div class="action-buttons" style="
                        ...
                        flex-wrap: wrap;
                    ">
                        <button type="button" class="session-details-btn" onclick="window.location.href='${appointment && appointment.id ? '/followup-session/' + appointment.id + '/' : '/counselor/reports/' }'" style="
                            padding: 12px 24px;
                            border-radius: 8px;
                            font-size: 14px;
                            font-weight: 600;
                            ...
                            color: white;
                            transition: all 0.3s ease;
                        " onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 5px 15px rgba(46,204,113,0.3)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
                            <i class="bx bx-file"></i> View Session Details
                        </button>
                        ${appointmentType && (appointmentType.toLowerCase().includes('video') || appointmentType.toLowerCase().includes('online') || appointmentType.toLowerCase().includes('remote')) ? `
                        <button type="button" class="video-recording-btn" onclick="window.open('${appointment && appointment.video_call_url ? appointment.video_call_url : '#'}', '_blank')" style="
                            padding: 12px 24px;
                            border-radius: 8px;
                            font-size: 14px;
                            font-weight: 600;
                        ...
                        ` : ''}
                        <button type="button" class="close-btn" onclick="notificationManager.closeScheduledFollowupModal()" style="
                            padding: 12px 24px;
                            border-radius: 8px;
                            font-size: 14px;
                            font-weight: 600;
                            ...
                            color: white;
                            transition: all 0.3s ease;
                        " onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 5px 15px rgba(0,0,0,0.2)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
