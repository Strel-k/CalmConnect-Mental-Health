    ...
    renderScheduledFollowupContent(data, metadata) {
        ...
        try {
            ...
            if (sessionDetailsUrl !== '#') {
                html.push('<button type="button" class="session-details-btn" onclick="window.location.href=\'');
                html.push(sessionDetailsUrl);
                html.push('\'" style="padding: 12px 24px; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: pointer; border: none; background: linear-gradient(135deg, #2ecc71, #27ae60); color: white; transition: all 0.3s ease;" onmouseover="this.style.transform=\'translateY(-2px)\'; this.style.boxShadow=\'0 5px 15px rgba(46,204,113,0.3)\'" onmouseout="this.style.transform=\'translateY(0)\'; this.style.boxShadow=\'none\'">');
                html.push('<i class="bx bx-file"></i> View Session Details');
                html.push('</button>');
            } else {
                html.push('<button type="button" class="session-details-btn" disabled style="padding: 12px 24px; border-radius: 8px; font-size: 14px; font-weight: 600; cursor: not-allowed; border: none; background: linear-gradient(135deg, #95a5a6, #7f8c8d); color: white; opacity: 0.6;">');
                html.push('<i class="bx bx-file"></i> Session Details Unavailable');
                html.push('</button>');
            }
